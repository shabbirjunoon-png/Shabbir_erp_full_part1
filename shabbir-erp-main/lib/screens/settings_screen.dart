      ...
      body: Column(children: [
        ...
        Expanded(child: ListView(
          ...
          children: [
            ...
            // ── GitHub Gist Backup ──
            _SectionLabel(locale.t3('Online Backup (GitHub Gist)', 'Online Backup (GitHub Gist)', 'آن لائن بیک اپ (GitHub Gist)')),
            _Tile(icon: Icons.cloud_upload_outlined, title: locale.t3('Online Backup', 'Online Backup', 'آن لائن بیک اپ'), subtitle: locale.t3('Save to GitHub Gist', 'GitHub Gist par save karo', 'GitHub Gist پر محفوظ کریں'), loading: _loadingGistBackup, onTap: _gistBackup),
            _Tile(icon: Icons.cloud_download_outlined, title: locale.t3('Restore Online', 'Online se Restore', 'آن لائن سے ریسٹور'), subtitle: locale.t3('Restore data from Gist ID', 'Gist ID se data wapas lao', 'Gist ID سے ڈیٹا واپس لائیں'), loading: _loadingGistRestore, onTap: _gistRestore),
            const SizedBox(height: 24),
